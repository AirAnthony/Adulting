...
public class ProfileActivity extends AppCompatActivity {
    ...
    private TextView emailInfo, totalExpenses;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String emailInformation = getIntent().getStringExtra("keyname");
        String totalExpensesInformation = getIntent().getStringExtra("keynameTwo");


        emailInfo.setText(emailInformation);
        totalExpenses.setText(totalExpensesInformation);
