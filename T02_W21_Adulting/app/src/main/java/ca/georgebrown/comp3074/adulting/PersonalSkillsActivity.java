...
public class PersonalSkillsActivity extends AppCompatActivity {
    ...
    private TextView quizzesPersonalSkills;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        time = (TextView)findViewById(R.id.txtHowToManageYourTime);
        relationships = (TextView)findViewById(R.id.txtHowToBuildLastingRelationships);
        quizzesPersonalSkills = (TextView)findViewById(R.id.txtQuizzesForPersonalSkills);
        ...
        time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentTwo = new Intent(PersonalSkillsActivity.this, HowToManageYourTimeActivity.class);
        ...
        relationships.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentThree = new Intent(PersonalSkillsActivity.this, HowToBuildLastingRelationships.class);
                startActivity(intentThree);
            }
        });

        quizzesPersonalSkills.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentThree = new Intent(PersonalSkillsActivity.this, PersonalSkillsStartActivity.class);
                startActivity(intentThree);
            }
        });
