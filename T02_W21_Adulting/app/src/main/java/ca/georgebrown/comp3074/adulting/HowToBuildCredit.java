...
public class HowToBuildCredit extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_how_to_build_credit);

        /*
        ConstraintLayout constraintLayout = findViewById(R.id.layoutForHowToBuildCredit);
