...
public class FinanceActivity extends AppCompatActivity {
    ...
    private TextView quizzesFinance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConstraintLayout constraintLayout = findViewById(R.id.layoutForFinance);
        ...
        //initialize buttons
        Button goBackBtn = (Button) findViewById(R.id.btnBackToMenu);
        budget = (TextView)findViewById(R.id.txtHowToMakeABudget);
        credit = (TextView)findViewById(R.id.txtHowToBuildCredit);
        debt = (TextView)findViewById(R.id.txtHowToGetOutOfDebt);
        quizzesFinance = (TextView)findViewById(R.id.txtFinanceStart);
        ...
        budget.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FinanceActivity.this, HowToMakeABudgetActivity.class);
        ...
        credit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentTwo = new Intent(FinanceActivity.this, HowToBuildCredit.class);
        ...
        debt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentThree = new Intent(FinanceActivity.this, HowToGetOutOfDebtActivity.class);
                startActivity(intentThree);
            }
        });

        quizzesFinance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentFour = new Intent(FinanceActivity.this, FinanceStartActivity.class);
