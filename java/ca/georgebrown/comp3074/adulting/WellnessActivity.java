...
public class WellnessActivity extends AppCompatActivity {
    ...
    private TextView toxic;
    private TextView quizzesWellness;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toxic = (TextView)findViewById(R.id.txtHowToDealWithToxicPeople);
        quizzesWellness = (TextView)findViewById(R.id.txtHowToDealWithToxicPeople2);
        ...
        stress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentTwo = new Intent(WellnessActivity.this, HowToDealWithStress.class);
        ...
        toxic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentThree = new Intent(WellnessActivity.this, HowToDealWithToxicPeople.class);
                startActivity(intentThree);
            }
        });

        quizzesWellness.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentThree = new Intent(WellnessActivity.this, WellnessStartActivity.class);
                startActivity(intentThree);
            }
        });
