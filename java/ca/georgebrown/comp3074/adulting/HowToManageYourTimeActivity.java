...
public class HowToManageYourTimeActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_how_to_manage_your_time);

        /*
        ConstraintLayout constraintLayout = findViewById(R.id.layoutForHowToManageYourTime);
