...
public class HowToDealWithToxicPeople extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_how_to_deal_with_toxic_people);

        /*
        ConstraintLayout constraintLayout = findViewById(R.id.layoutForHowToDealWithToxicPeople);
