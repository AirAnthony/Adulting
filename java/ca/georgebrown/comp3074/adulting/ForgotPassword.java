...
public class ForgotPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emailEditText = (EditText)findViewById(R.id.editTextEnterEmail);
        ...
        ConstraintLayout constraintLayout = findViewById(R.id.layoutForForgotPassword);
        ...
        resetPasswordButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String email_value = emailEditText.getText().toString().trim();
                ...
                auth.sendPasswordResetEmail(email_value).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
